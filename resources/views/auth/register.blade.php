...
<html lang="en">
    <head>
        ...
        <title>Register - Liugong Bangladesh Admin</title>
                                    ...
                                    <div class="card-body">
                                        ...
                                        @endif
                                            ...
                                            <div class="form-floating mb-3">
                                                <input class="form-control" id="inputUserName" name="inputUserName" type="text" placeholder="Enter your user name" value="{{old('inputUserName')}}" />
                                                <label for="inputUserName">User name</label>
                                                <span class="text-danger">@error('inputUserName'){{$message}} @enderror</span>
                                            </div>
                                            
                                            <div class="form-floating mb-3">
                                                <input class="form-control" id="email" name="email" type="email" placeholder="name@example.com" value="{{old('inputEmail')}}" />
