                ...
                @foreach($product as $i)
                    <div class="col-lg-4 col-md-4 all {{$i->product_class}}">
                      <div class="product-item">
                        <a href="#" data-toggle="modal" data-target="#noAnimModal{{$i->id}}"><img src="{{asset($i->product_image)}}" alt=""></a>
                        <div class="down-content">
                          <a href="#" data-toggle="modal" data-target="#noAnimModal{{$i->id}}"><h4>{{$i->product_name}}</h4></a>
                    ...
                    <div class="modal fade" id="noAnimModal{{$i->id}}" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
