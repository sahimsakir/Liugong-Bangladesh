...
<html lang="en">
    <head>
        ...
        <title>User Add - LiuGong Bangladesh Admin</title>
                                ...
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    ...
                                    <form method="post" enctype="multipart/form-data">
                                            ...
                                            <div class="row mb-3">
                                                    <div class="form-floating mb-3 mb-md-0">
                                                        <h6>Password</h6>
                                                        <input class="form-control" id="inputPassword" name="inputPassword" type="password" value=""/> 
                                                        <span style="color:red;">@error('inputPassword'){{$message}} @enderror</span>
                                                    </div>
                                            </div>
                                            <div class="mt-4 mb-0">
