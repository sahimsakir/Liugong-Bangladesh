...
<html lang="en">
    <head>
        ...
        <title>Update Team Member - LiuGong Bangladesh Admin</title>
                                ...
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    ...
                                    <form method="post" enctype="multipart/form-data">
                                            ...
                                            <div class="row mb-3">
                                                <div class="col-md-12">
                                                    <div class="form-floating mb-3 mb-md-0">
                                                        <h6>Name</h6>
                                                        <input class="form-control" id="inputName" name="inputName" type="text" value="{{$i->member_name}}"/> 
                                            ...
                                            <div class="row mb-3">
                                                    <div class="form-floating mb-3 mb-md-0">
                                                        <h6>Designation</h6>
                                                        <input class="form-control" id="inputDesignation" name="inputDesignation" type="text" value="{{$i->member_designation}}"/> 
                                                        <span style="color:red;">@error('inputDesignation'){{$message}} @enderror</span>
                                                    </div>
                                            </div>
                                            <div class="row mb-3">
                                                    <div class="form-floating mb-3 mb-md-0">
                                                        <h6>Email</h6>
                                                        <input class="form-control" id="inputEmail" name="inputEmail" type="email" value="{{$i->member_email}}"/> 
                                                        <span style="color:red;">@error('inputEmail'){{$message}} @enderror</span>
                                                    </div>
                                            </div>
                                            <div class="row mb-3">
                                                <div class="preview-image">
                                                    <img src="{{asset($i->member_image)}}"/>
                                                </div>
                                                <h6>Change Image</h6>
                                            ...
                                            <div class="mt-4 mb-0">
                                                ...
                                                <div class="d-grid mb-2"><a class="btn btn-primary btn-block" href="/team-list">Back</a></div>
                                            </div>
