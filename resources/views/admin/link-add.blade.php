...
<html lang="en">
    <head>
        ...
        <title>Add Link - LiuGong Bangladesh Admin</title>
                                ...
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    ...
                                    <form method="post" enctype="multipart/form-data">
                                            ...
                                            <div class="row mb-3">
                                                    <div class="form-floating mb-3 mb-md-0">
                                                        <h6>Link</h6>
                                                        <input class="form-control" id="inputLink" name="inputLink" type="text" value=""/> 
                                            ...
                                            <div class="row mb-3">
                                                    <div class="form-floating mb-3 mb-md-0">
                                                        <h6>Icon</h6>
                                                        <input class="form-control" id="inputIcon" name="inputIcon" type="text" value=""/> 
