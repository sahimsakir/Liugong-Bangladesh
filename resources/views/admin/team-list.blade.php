...
<html lang="en">
    <head>
        ...
        <title>Team Member List - LiuGong Bangladesh Admin</title>
                            ...
                            <div class="card-header">
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-6 right-button">
                                        <a href="/team-add"><i class="fa fa-plus"></i></a>
                                ...
                                <table id="datatablesSimple">
                                    ...
                                    <tbody>
                                       @foreach($member as $i)
                                        <tr>
                                            <td>{{$i->member_name}}</td>
                                            <td>{{$i->member_designation}}</td>
                                            <td class="list-image"><a href="{{asset($i->member_image)}}" target="_blank"><img src="{{asset($i->member_image)}}"></a></td>
                                            <td><form action="/team-delete/{{$i->id}}" method="post" onsubmit="return confirm('Are you sure?');">
                                            @csrf
                                                <a href="/team-update/{{$i->id}}"><i class="fas fa-edit"></i></a>
