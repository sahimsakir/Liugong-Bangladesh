...
<html lang="en">
    <head>
        ...
        <title>Category List - LiuGong Bangladesh Admin</title>
                            ...
                            <div class="card-header">
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-6 right-button">
                                        <a href="/category-add"><i class="fa fa-plus"></i></a>
                                    ...
                                    <tbody>
                                       @foreach($category as $i)
                                        <tr>
                                            ...
                                            <td class="list-image"><a href="{{asset($i->category_image)}}" target="_blank"><img src="{{asset($i->category_image)}}"></a></td>
                                            <td><form action="/category-delete/{{$i->id}}" method="post" onsubmit="return confirm('Are you sure?');">
                                            @csrf
                                                <a href="/category-update/{{$i->id}}"><i class="fas fa-edit"></i></a>
