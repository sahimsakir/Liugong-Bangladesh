...
<html lang="en">
    <head>
        ...
        <title>User List - LiuGong Bangladesh Admin</title>
                                ...
                                <table id="datatablesSimple">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td></td>
                                            <td>{{$i->status}}</td>
                                            <td><form action="/user-delete/{{$i->id}}" method="post" onsubmit="return confirm('Are you sure?');">
                                            @csrf
                                                <a href="/user-update/{{$i->id}}"><i class="fas fa-edit"></i></a>
