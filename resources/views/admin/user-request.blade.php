...
<html lang="en">
    <head>
        ...
        <title>User Requests - LiuGong Bangladesh Admin</title>
        ...
        <div id="layoutSidenav_nav">
            ...
            <div id="layoutSidenav_content">
                <main>
                    ...
                    @endif
                        <h1 class="mt-4">Users Requests</h1>
                        ...
                        <div class="card mb-4">
                            <div class="card-header">
                                <div class="row mb-3">
                                    <div class="col-md-12 left-button">
                                ...
                                <table id="datatablesSimple">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>{{$i->created_at}}</td>
                                            <td>{{$i->status}}</td>
                                            <td><form action="/user-request-delete/{{$i->id}}" method="post" onsubmit="return confirm('Are you sure?');">
                                            @csrf
                                                <a href="/user-request-update/{{$i->id}}"><i class="fas fa-edit"></i></a>
