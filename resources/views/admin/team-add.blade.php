...
<html lang="en">
    <head>
        ...
        <title>Add Team Member - LiuGong Bangladesh Admin</title>
                                ...
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    ...
                                    <form method="post" enctype="multipart/form-data">
                                            ...
                                            <div class="row mb-3">
                                                <div class="col-md-12">
                                                    <div class="form-floating mb-3 mb-md-0">
                                                        <h6>Name</h6>
                                                        <input class="form-control" id="inputName" name="inputName" type="text" value=""/> 
                                            ...
                                            <div class="row mb-3">
                                                    <div class="form-floating mb-3 mb-md-0">
                                                        <h6>Designation</h6>
                                                        <input class="form-control" id="inputDesignation" name="inputDesignation" type="text" value=""/> 
                                            ...
                                            <div class="row mb-3">
                                                    <div class="form-floating mb-3 mb-md-0">
                                                        <h6>Email</h6>
                                                        <input class="form-control" id="inputEmail" name="inputEmail" type="email" value=""/> 
